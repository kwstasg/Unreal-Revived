...
$defaultIniLines = Set-UnrealRevivedIniValue $defaultIniLines 'XInputWinDrv.WindowsClient' 'LeftStickDeadZonePercent' '24.000000'
$defaultIniLines = Set-UnrealRevivedIniValue $defaultIniLines 'XInputWinDrv.WindowsClient' 'RightStickDeadZonePercent' '27.000000'
$defaultIniLines = Set-UnrealRevivedIniValue $defaultIniLines 'XInputWinDrv.WindowsClient' 'ScaleXYZ' '85.000000'
