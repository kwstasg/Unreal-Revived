...
$defaultIniLines = Set-UnrealRevivedIniValue $defaultIniLines 'WinDrv.WindowsClient' 'ScaleXYZ' '85.000000'
$defaultIniLines = Set-UnrealRevivedIniValue $defaultIniLines 'WinDrv.WindowsClient' 'ScaleRUV' '85.000000'
