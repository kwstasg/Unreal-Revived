...
$defaultIniLines = Set-UnrealRevivedIniValue $defaultIniLines 'D3D12Drv.D3D12RenderDevice' 'VignetteIntensity' '0'
$defaultIniLines = Set-UnrealRevivedIniValue $defaultIniLines 'D3D12Drv.D3D12RenderDevice' 'FilmGrainAmount' '0'
$defaultIniLines = Set-UnrealRevivedIniValue $defaultIniLines 'D3D12Drv.D3D12RenderDevice' 'ScanlineStrength' '0'
