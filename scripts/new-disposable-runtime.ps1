...
try {
    ...
    $iniLines = Set-UnrealRevivedIniValue $iniLines 'WinDrv.WindowsClient' 'ScaleXYZ' '100.000000'
    $iniLines = Set-UnrealRevivedIniValue $iniLines 'WinDrv.WindowsClient' 'ScaleRUV' '100.000000'
    ...
    $iniLines = Set-UnrealRevivedIniValue $iniLines 'D3D12Drv.D3D12RenderDevice' 'VignetteIntensity' '0'
    $iniLines = Set-UnrealRevivedIniValue $iniLines 'D3D12Drv.D3D12RenderDevice' 'FilmGrainAmount' '0'
    $iniLines = Set-UnrealRevivedIniValue $iniLines 'D3D12Drv.D3D12RenderDevice' 'ScanlineStrength' '0'
    ...
    $iniLines = Set-UnrealRevivedIniValue $iniLines 'XInputWinDrv.WindowsClient' 'ScaleXYZ' '100.000000'
    $iniLines = Set-UnrealRevivedIniValue $iniLines 'XInputWinDrv.WindowsClient' 'ScaleRUV' '100.000000'
    ...
    $userIniLines = Set-UnrealRevivedIniValue $userIniLines 'Engine.Input' 'Joy10' 'RecenterVR'
    $userIniLines = Set-UnrealRevivedIniValue $userIniLines 'Engine.Input' 'F10' 'RecenterVR'
