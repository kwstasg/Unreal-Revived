...
#if defined(UNREAL_227)
	void DrawGouraudPolyList(FSceneNode* Frame, FTextureInfo& Info, FTransTexture* Pts, int NumPts, DWORD PolyFlags, FSpanBuffer* Span = nullptr) override;
#endif
...
private:
	...
	bool IgnoreBorderlessResize = false;
	int CurrentSizeX = 0;
	int CurrentSizeY = 0;
#if defined(UNREAL_227)
	FViewportCallback* ViewportCallback = nullptr;
	FViewportCallback* OriginalViewportCallback = nullptr;
#endif
};
